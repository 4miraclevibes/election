...
<div class="container py-4">
    ...
    <section class="data mt-5">
        <h5 class="section-title mb-3">Data Pemilih <span class="text-success">{{ Auth::user()->tpsElectionDetails->tpsElection->kelurahanElection->name }} Tps {{ Auth::user()->tpsElectionDetails->tpsElection->name }}</span></h5>
